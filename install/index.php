                    ...
                    <div id="step2" style="display:none;">
                        <form action="#" method="post">
                            <div class="form-step1">
                                ...
                                <a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank" class="hints">Where is my Envato purchase code?</a>
                                <input type="text" id="purchasecode" name="purchasecode" placeholder="Enter Envato Purchase Code" value="dharunmods" readonly="readonly" required>
